...
/**
 * Runtime benchmark for the Kotlin [Kissat] (core) port (JVM).
 *
 ...
 *
 * The companion script `shadow/tools/benchmark_kissat.sh` builds the C reference
 * (`c++ -O2 -std=c++17 kissat_trace.cc`), times it on the SAME CNFs, and prints a
 ...
 *
 * Usage: ./gradlew :kissat:runBenchmark
 */
object Benchmark {
    ...
    fun main(args: Array<String>) {
        ...
        println("# Kotlin kissat (core) benchmark (solve-only, median of $RUNS runs, $WARMUP warm-up)")
