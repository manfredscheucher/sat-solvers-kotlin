...
/**
 * Target-independent sanity + L3 tests for the Kotlin [Kissat] (core) port. These run on
 ...
 * CNF. The full step-by-step trace shadow against the C kissat core lives in the JVM-only
 * ShadowTraceFilesTest, which reads the golden traces produced by kissat_trace.cc.
 */
class KissatSanityTest {
